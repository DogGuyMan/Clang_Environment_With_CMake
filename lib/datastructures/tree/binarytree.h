#ifndef __HEADER_GUARD_BINARYTREE__
#define __HEADER_GUARD_BINARYTREE__
...
struct BinaryTree__TYPE_NAME__ {
    ...
    BinaryTree__TYPE_NAME__ *   ( * const insert)           	(BinaryTree__TYPE_NAME__ * self_ptr, BinaryTree__TYPE_NAME__ * current_tree, E_BINARY_TREE_INSERT_MODE insert_mode, BinaryTree__TYPE_NAME__ * insert_tree);
...
BinaryTree__TYPE_NAME__ *   BinaryTree__TYPE_NAME___SPSP_Insert(BinaryTree__TYPE_NAME__ * self_ptr, BinaryTree__TYPE_NAME__ * current_tree, E_BINARY_TREE_INSERT_MODE insert_mode, BinaryTree__TYPE_NAME__ * insert_tree);
...
void BinaryTree__TYPE_NAME___SPSP_DataSwap(BinaryTree__TYPE_NAME__ *lhs, BinaryTree__TYPE_NAME__ *rhs);
void BinaryTree__TYPE_NAME___SPSP_LeftReconnectSubtree(BinaryTree__TYPE_NAME__ *parent, BinaryTree__TYPE_NAME__ *left_subtree);
void BinaryTree__TYPE_NAME___SPSP_RightReconnectSubtree(BinaryTree__TYPE_NAME__ *parent, BinaryTree__TYPE_NAME__ *right_subtree);
#endif//__HEADER_GUARD_BINARYTREE__
